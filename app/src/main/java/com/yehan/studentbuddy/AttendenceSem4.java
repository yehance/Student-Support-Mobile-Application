...
public class AttendenceSem4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendence_sem4);

        //initializing the variables
        module = findViewById(R.id.moduleNameTextAS4);
        weeks=findViewById(R.id.weeksTextS4);
        absent=findViewById(R.id.AbsentTextS4);

        insert=findViewById(R.id.btnInsertAS4);
        update=findViewById(R.id.btnUpdateAS4);
        delete=findViewById(R.id.btnDeleteAS4);
        view=findViewById(R.id.btnViewAS4);

        //Setting table name
        String tableName = "attendanceSem4";
        ...
        insert.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkInsertData==true){
                    Toast.makeText(AttendenceSem4.this,"New Entry Inserted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem4.this,"New Entry not Inserted",Toast.LENGTH_SHORT).show();
                }
        ...
        update.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkUpdateData==true){
                    Toast.makeText(AttendenceSem4.this,"Entry Updated",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem4.this,"Entry not Updated",Toast.LENGTH_SHORT).show();
                }
        ...
        delete.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkDeleteData==true){
                    Toast.makeText(AttendenceSem4.this,"Entry Deleted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem4.this,"Entry not Deleted",Toast.LENGTH_SHORT).show();
                }
        ...
        view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(result.getCount()==0){
                    Toast.makeText(AttendenceSem4.this,"No Entry Exists",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AttendenceSem4.this);
