...
public class ResultsSem2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_results_sem2);

        //initializing the variables
        module = findViewById(R.id.moduleNameTextS2);
        credits=findViewById(R.id.creditTextS2);
        result=findViewById(R.id.ResultTextS2);

        insert=findViewById(R.id.btnInsertS2);
        update=findViewById(R.id.btnUpdateS2);
        delete=findViewById(R.id.btnDeleteS2);
        view=findViewById(R.id.btnViewS2);

        //Setting table name
        String tableName = "resultsSem2";
        ...
        insert.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkInsertData==true){
                    Toast.makeText(ResultsSem2.this,"New Entry Inserted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(ResultsSem2.this,"New Entry not Inserted",Toast.LENGTH_SHORT).show();
                }
        ...
        update.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkUpdateData==true){
                    Toast.makeText(ResultsSem2.this,"Entry Updated",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(ResultsSem2.this,"Entry not Updated",Toast.LENGTH_SHORT).show();
                }
        ...
        delete.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkDeleteData==true){
                    Toast.makeText(ResultsSem2.this,"Entry Deleted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(ResultsSem2.this,"Entry not Deleted",Toast.LENGTH_SHORT).show();
                }
        ...
        view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(result.getCount()==0){
                    Toast.makeText(ResultsSem2.this,"No Entry Exists",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ResultsSem2.this);
