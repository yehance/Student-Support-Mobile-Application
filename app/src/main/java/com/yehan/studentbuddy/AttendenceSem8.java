...
public class AttendenceSem8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendence_sem8);

        //initializing the variables
        module = findViewById(R.id.moduleNameTextAS8);
        weeks=findViewById(R.id.weeksTextS8);
        absent=findViewById(R.id.AbsentTextS8);

        insert=findViewById(R.id.btnInsertAS8);
        update=findViewById(R.id.btnUpdateAS8);
        delete=findViewById(R.id.btnDeleteAS8);
        view=findViewById(R.id.btnViewAS8);

        //Setting table name
        String tableName = "attendanceSem8";
        ...
        insert.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkInsertData==true){
                    Toast.makeText(AttendenceSem8.this,"New Entry Inserted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem8.this,"New Entry not Inserted",Toast.LENGTH_SHORT).show();
                }
        ...
        update.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkUpdateData==true){
                    Toast.makeText(AttendenceSem8.this,"Entry Updated",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem8.this,"Entry not Updated",Toast.LENGTH_SHORT).show();
                }
        ...
        delete.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkDeleteData==true){
                    Toast.makeText(AttendenceSem8.this,"Entry Deleted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem8.this,"Entry not Deleted",Toast.LENGTH_SHORT).show();
                }
        ...
        view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(result.getCount()==0){
                    Toast.makeText(AttendenceSem8.this,"No Entry Exists",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AttendenceSem8.this);
