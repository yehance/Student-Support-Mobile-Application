...
public class ResultsSem6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_results_sem6);

        //initializing the variables
        module = findViewById(R.id.moduleNameTextS6);
        credits=findViewById(R.id.creditTextS6);
        result=findViewById(R.id.ResultTextS6);

        insert=findViewById(R.id.btnInsertS6);
        update=findViewById(R.id.btnUpdateS6);
        delete=findViewById(R.id.btnDeleteS6);
        view=findViewById(R.id.btnViewS6);

        //Setting table name
        String tableName = "resultsSem6";
        ...
        insert.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkInsertData==true){
                    Toast.makeText(ResultsSem6.this,"New Entry Inserted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(ResultsSem6.this,"New Entry not Inserted",Toast.LENGTH_SHORT).show();
                }
        ...
        update.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkUpdateData==true){
                    Toast.makeText(ResultsSem6.this,"Entry Updated",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(ResultsSem6.this,"Entry not Updated",Toast.LENGTH_SHORT).show();
                }
        ...
        delete.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkDeleteData==true){
                    Toast.makeText(ResultsSem6.this,"Entry Deleted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(ResultsSem6.this,"Entry not Deleted",Toast.LENGTH_SHORT).show();
                }
        ...
        view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(result.getCount()==0){
                    Toast.makeText(ResultsSem6.this,"No Entry Exists",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ResultsSem6.this);
