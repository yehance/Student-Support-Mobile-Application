...
public class AttendenceSem5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendence_sem5);

        //initializing the variables
        module = findViewById(R.id.moduleNameTextAS5);
        weeks=findViewById(R.id.weeksTextS5);
        absent=findViewById(R.id.AbsentTextS5);

        insert=findViewById(R.id.btnInsertAS5);
        update=findViewById(R.id.btnUpdateAS5);
        delete=findViewById(R.id.btnDeleteAS5);
        view=findViewById(R.id.btnViewAS5);

        //Setting table name
        String tableName = "attendanceSem5";
        ...
        insert.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkInsertData==true){
                    Toast.makeText(AttendenceSem5.this,"New Entry Inserted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem5.this,"New Entry not Inserted",Toast.LENGTH_SHORT).show();
                }
        ...
        update.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkUpdateData==true){
                    Toast.makeText(AttendenceSem5.this,"Entry Updated",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem5.this,"Entry not Updated",Toast.LENGTH_SHORT).show();
                }
        ...
        delete.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkDeleteData==true){
                    Toast.makeText(AttendenceSem5.this,"Entry Deleted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem5.this,"Entry not Deleted",Toast.LENGTH_SHORT).show();
                }
        ...
        view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(result.getCount()==0){
                    Toast.makeText(AttendenceSem5.this,"No Entry Exists",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AttendenceSem5.this);
