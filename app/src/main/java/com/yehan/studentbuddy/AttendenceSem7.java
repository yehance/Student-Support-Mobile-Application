...
public class AttendenceSem7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendence_sem7);

        //initializing the variables
        module = findViewById(R.id.moduleNameTextAS7);
        weeks=findViewById(R.id.weeksTextS7);
        absent=findViewById(R.id.AbsentTextS7);

        insert=findViewById(R.id.btnInsertAS7);
        update=findViewById(R.id.btnUpdateAS7);
        delete=findViewById(R.id.btnDeleteAS7);
        view=findViewById(R.id.btnViewAS7);

        //Setting table name
        String tableName = "attendanceSem7";
        ...
        insert.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkInsertData==true){
                    Toast.makeText(AttendenceSem7.this,"New Entry Inserted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem7.this,"New Entry not Inserted",Toast.LENGTH_SHORT).show();
                }
        ...
        update.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkUpdateData==true){
                    Toast.makeText(AttendenceSem7.this,"Entry Updated",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem7.this,"Entry not Updated",Toast.LENGTH_SHORT).show();
                }
        ...
        delete.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(checkDeleteData==true){
                    Toast.makeText(AttendenceSem7.this,"Entry Deleted",Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(AttendenceSem7.this,"Entry not Deleted",Toast.LENGTH_SHORT).show();
                }
        ...
        view.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(result.getCount()==0){
                    Toast.makeText(AttendenceSem7.this,"No Entry Exists",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AttendenceSem7.this);
